...
export default async function annualInspectionRoutes(fastify: FastifyInstance) {
  // Apply authentication to all routes
  fastify.addHook('preHandler', fastify.authenticate);

  // Create annual inspection (Draft)
    ...
    schema: {
      ...
      body: {
        ...
        required: [
          ...
          'ownerAdvisedPaintDamage', 'ownerUnderstandsOperation', 'corrosionFound'
        ],
        properties: {
  ...
  // Validate inspection for submission
