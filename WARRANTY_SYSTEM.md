...
- Create and manage warranty terms and conditions
...
```json
{
  "warrantyName": "ECO-PRO - 10 Year Corrosion, 5 Year Product - Rev 8",
...
### Form Fields (Based on Images)

The warranty terms creation form includes these fields:

**Add Type:**
- Dropdown with options: "Add Warranty", "Replace Warranty - Select Warranty to Replace below"

**Warranty to Replace:**
- Radio buttons with "None" selected by default
- List of existing warranty terms (e.g., "ECO-PRO - 10 Year Corrosion, 5 Year Product - Rev 8")
...
- Revision (required)
- Generator Light Colour (optional)
...
The warranty creation form includes all fields shown in the provided images:

**Agent Selection:**
- Dropdown to select agent account
...
**Installation Details:**
- Product Installed (dropdown from warranty terms)
...
This comprehensive warranty management system provides all the functionality described in your requirements, with proper database design, API endpoints, and admin controls.